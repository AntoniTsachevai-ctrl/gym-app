      ...
      <main className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold mb-4 text-lime-400">
              Get in Touch
            </h1>
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Have questions about our trainers or services? We're here to help
            ...
            <div className="space-y-8">
              ...
              <div className="bg-zinc-900/50 backdrop-blur rounded-2xl p-8 border border-zinc-800">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="w-12 h-12 bg-zinc-800 rounded-lg flex items-center justify-center hover:bg-lime-400 hover:text-black transition-colors"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
